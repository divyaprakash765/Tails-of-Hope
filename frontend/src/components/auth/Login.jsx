...
const Login = () => {
  ...
  return (
    ...
    <Button className = "mt-4 ml-[96vh] flex items-center"><Link to="/register"><i class="ri-arrow-left-fill mt-1 mr-2"></i>Signin</Link></Button>
        ...
        <div className="py-20 px-40">
            <Label className="text-white text-3xl font-semibold">Login</Label>
            <div className="mt-4">
            <Form className="">
            ...
            <FormItem className="mt-4">
              <FormLabel>Choose your role<br /></FormLabel>
              <DropdownMenu>
